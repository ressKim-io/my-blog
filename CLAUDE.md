...
### Key Directories
- `src/content/{track}/{category}/` - MDX blog posts. track ∈ {essays, logs}, category ∈ {kubernetes, istio, challenge, monitoring, argocd, cicd, network, rust}
...
## Blog Content Stats (2026-07-01 기준, 자동 생성)

- **총 글 수**: 316개 (go-ti 프로젝트 실전 기록 210편 포함)
- **카테고리 (8개)**:
...
- **주요 시리즈** (편수 순):
  ...
  - 기존 시리즈 (15개): eks-troubleshooting (9), game-server (7), istio-ambient (7), rust-cs-layer (7), packet-journey (6), argocd-troubleshooting (5), challenge-2-wealist-migration (5), istio-traffic (5), istio-observability (4), istio-security (4), istio-intro (3), queue-poc-loadtest (3), eks-security (2), observability (2), eks-infra (1)
- **월별 분포**: 2025-10: 15 / 2025-11: 1 / 2025-12: 33 / 2026-01: 9 / 2026-02: 29 / 2026-03: 77 / 2026-04: 139 / 2026-06: 13
