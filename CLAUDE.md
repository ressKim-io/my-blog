...
## Blog Content Stats (2026-05-08 기준, 자동 생성)

- **총 글 수**: 244개 (go-ti 프로젝트 실전 기록 151편 포함)
- **카테고리 (6개)**:
  - `challenge` (85): 게임서버/POC/부하테스트/AI 워크플로우 경험 시리즈
  - `monitoring` (51): Prometheus, OpenTelemetry, Grafana, Loki, Tempo, Mimir
  - `kubernetes` (47): K8s 기본, EKS, Helm, KEDA, Karpenter, 스케일링
...
- **유형 메타 태그**: `troubleshooting` (109) / `adr` (40) / `concept` (25) / `retrospective` (11)
...
- **월별 분포**: 2025-10: 15 / 2025-11: 1 / 2025-12: 33 / 2026-01: 9 / 2026-02: 29 / 2026-03: 60 / 2026-04: 97
...
2. **카테고리 폴더 선택**: kubernetes / istio / challenge / monitoring / argocd / cicd 중 택1
