...
### 4.1 문체·구조 (★1.1 파일럿 피드백으로 확정, 2026-07-10)
- **격식체(-습니다체) + 마침표 유지** — 이 시리즈는 심화 산문이라 rust-cs-layer 관례를
  따름 (goti 글의 마침표 생략 관례와 다름). 리듬용 "~죠"는 가끔 허용
...
- 편당 SVG 3~6개 예상. SVG 라벨은 기존 관례대로 **영문**, 상세 설명은 본문 한글로
