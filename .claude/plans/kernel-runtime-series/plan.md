...
> 마지막 갱신: 2026-07-10 (2.2 발행 완료, 다음 착수 = 2.3)
> ★ 2026-07-10 SVG 글자 최소화 원칙 확정 — §4.2 하단 참조. 1.1~2.1 기존 SVG 26개는 아직 미적용
...
작성돼 **전부 위반** 상태입니다 (계측: 26/26이 13px 미만 텍스트 보유, 라벨 최대 103자).
