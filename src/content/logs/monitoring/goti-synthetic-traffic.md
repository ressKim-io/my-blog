...
excerpt: "부하 도구가 아닙니다. dev 환경 대시보드가 '데이터가 없어 비어 보이는' 문제를 해소하기 위해 K6 CronJob으로 상시 합성 트래픽을 발생시킨 설계와 운영 기록입니다"
category: monitoring
tags:
  - go-ti
  - Synthetic-Traffic
...
![합성 트래픽 CronJob 아키텍처와 mTLS 호출 흐름](/diagrams/goti-synthetic-traffic-1.svg)
