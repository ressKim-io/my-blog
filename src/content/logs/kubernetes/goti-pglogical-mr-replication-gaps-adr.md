...
- [pglogical 복제의 신뢰성 한계 — HA 부재·PITR·WAL archiving](/essays/goti-deepdive-pglogical-reliability)
- [split-brain과 복제 정합성 — 양쪽 쓰기를 막고 멱등으로 중복을 흡수하는 원리](/essays/goti-deepdive-split-brain-consistency)
- [복제 연결 보안 — TLS 검증, 인증 방식, 최소 권한 설계](/essays/goti-deepdive-replication-channel-security)
