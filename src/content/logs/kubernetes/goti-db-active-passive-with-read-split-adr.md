...
![정상 상태 — GCP primary 다중 클라우드 DB 토폴로지](/diagrams/goti-db-active-passive-with-read-split-adr-1.svg)
...
- [Active-Passive 복제 토폴로지 — 단일 쓰기 지점이 충돌을 없애는 원리](/essays/goti-deepdive-active-passive-topology)
- [pglogical replication set — 복제 범위 제어와 시퀀스 드리프트](/essays/goti-deepdive-pglogical-replication-set)
