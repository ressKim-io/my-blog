...
![Terraform·K8s manifest 레이어 호환성 격차](/diagrams/goti-gcp-terraform-cross-cloud-review-1.svg)
...
![Overlay·ApplicationSet 기반 해결 구조](/diagrams/goti-gcp-terraform-cross-cloud-review-2.svg)
