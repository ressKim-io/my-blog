...
![Sidecar vs Ambient 워터폴 트레이스 뷰 비교](/diagrams/goti-adr-istio-service-mesh-1.svg)
...
![Goti의 Istio Sidecar 채택 — 전체 아키텍처](/diagrams/goti-adr-istio-service-mesh-2.svg)
...
- [Istio 서비스 메시 동작 원리 — Envoy 주입부터 xDS·mTLS까지](/essays/goti-deepdive-istio-service-mesh)
- [Istio 데이터 플레인 — Sidecar와 Ambient의 내부 동작 차이](/essays/goti-deepdive-istio-sidecar-vs-ambient)
