...
2. **OTel init container 주입이 실패했는가?** — `kubectl describe pod`의 container 목록에서 `opentelemetry-auto-instrumentation-java`가 정상적으로 확인했습니다. 기각했습니다.
...
![goti namespace 관측성 파이프라인 — Agent에서 Grafana까지](/diagrams/goti-otel-agent-otlp-protocol-mismatch-1.svg)
