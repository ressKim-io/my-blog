...
```
┌─────────────────────────────────────────────────────────────────┐
│                  Mirror는 Fire-and-Forget                       │
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│   원본 요청 (v1)                                                │
│   ═════════════                                                 │
│   요청 → v1 처리 → 응답 대기 → 사용자에게 응답                  │
│                                                                 │
│   미러 요청 (v2)                                                │
│   ═════════════                                                 │
│   요청 복제 → v2로 전송 → 응답? 안 기다림!                      │
│                         └──▶ "보내고 잊어버림"                  │
│                                                                 │
│   결과:                                                         │
│   - v2 응답 시간이 사용자 경험에 영향 없음                      │
│   - v2 에러가 사용자에게 전달되지 않음                          │
│   - v2 응답은 메트릭/로그로만 확인 가능                         │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
