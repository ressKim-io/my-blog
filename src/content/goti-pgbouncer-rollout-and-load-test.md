...
> ADR에서 session 모드를 채택한 뒤 실제 배포하는 과정에서 5개 트러블이 연달아 터졌습니다. 1차 3000 VU 부하테스트에서 ticket_success 15.6%라는 초라한 결과가 나왔는데, 진짜 병목은 DB 연결 과부하가 아니라 ANALYZE 미실행으로 인한 통계 부재였습니다
