...
**궁금했던 것:**
- 신버전 배포 시 일부 트래픽만 보내는 카나리 배포를 어떻게 합니까?
- 특정 사용자 그룹만 신기능 테스트하는 A/B 테스팅은 어떻게 합니까?
- 서비스가 장애나면 호출 중단하는 Circuit Breaker는 어떻게 구현합니까?
...
가장 실용적인 기능입니다. 신버전을 조심스럽게 배포하는 방법입니다.
...
**서브셋(Subset)**: "v1 Pod들", "v2 Pod들"처럼 그룹을 나눕니다.
...
서비스가 장애나면 호출을 중단해서 장애 전파를 막습니다.
...
실제로 Payment Service를 일부러 죽여보겠습니다.
